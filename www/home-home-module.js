...
let HomePage = class HomePage {
    ...
    login(userName, password) {
        var url = "http://localhost/food-ordering-system-master/api/router-api.php";
        ...
        this.httpObj.post(url, { username: userName, password: password }, options).subscribe(data => {
